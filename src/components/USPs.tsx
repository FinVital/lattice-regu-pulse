...
const usps = [
  ...
  },
  {
    ...
    description: 'GDPR compliant with support for international regulatory frameworks across 150+ jurisdictions.',
  ...
  },
  {
    ...
    description: 'Sub-second response times with 24/7 monitoring and automated compliance workflows.',
  ...
  },
  {
    ...
    description: 'PCI DSS Level 1 certified for secure payment processing and financial data protection.',
    color: 'compliance' as const,
  },
];
